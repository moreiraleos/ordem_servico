...
if ($counter > 0) {
	...
	$("#table_servicos tr").each(function () {
		/*Armazena na variável produto, o valor contido no input 'servico_descricao'*/
		...
		select: function (event, ui) {
			...
			if (ui.item.value === "Serviço não encontrado") {
				...
				var markup =
					...
					servico_descricao +
					'" class="servico_descricao form-control form-control-user input-sm" data-cell="B' +
					i +
					'" readonly></td>\
                    <td><input title="Valor unitário do servico" name="servico_preco[]" value="' +
					servico_preco +
					'" class="form-control form-control-user input-sm text-right money pr-1" data-cell="C' +
					i +
					'" data-format="R$ 0,0.00" readonly></td>\
                    <td><input title="Digite a quantidade apenas em número inteiros" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" name="servico_quantidade[]" value="" class="qty form-control form-control-user text-center" data-cell="D' +
					i +
					'" data-format="0[.]00" required></td>\
                    <td><input title="Insira o desconto" name="servico_desconto[]" class="form-control form-control-user input-sm text-right" value="0" data-cell="E' +
					i +
					'" data-format="0,0[.]00 %" required></td>\
                    <td><input title="Valor total do servico selecionado" name="servico_item_total[]" class="form-control form-control-user input-sm text-right pr-1" data-cell="F' +
					i +
