		...
		select: function (event, ui) {
			...
			if (ui.item.value === "Produto não encontrado") {
				...
				var markup =
					...
					produto_descricao +
					'" class="produto_descricao form-control form-control-user input-sm" data-cell="B' +
					i +
					'" readonly></td>\
                    ...
                    <td><input title="Digite a quantidade apenas em número inteiros" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" name="produto_quantidade[]" value="" class="qty form-control form-control-user text-center" data-cell="D' +
					i +
					'" data-format="0[.]00" required></td>\
                    <td><input title="Insira o desconto" name="produto_desconto[]" class="form-control form-control-user input-sm text-right" value="0" data-cell="E' +
					i +
					'" data-format="0,0[.]00 %" required></td>\
                    <td><input title="Valor total do produto selecionado" name="produto_item_total[]" class="form-control form-control-user input-sm text-right pr-1" data-cell="F' +
					i +
