...
class HomeModel extends CI_Model
{
    ...
    public function get_contas_receber_vencem_hoje()
    {
        $this->db->select([
            'contas_receber.*',
            'cliente_id',
            'CONCAT("clientes.cliente_nome"," ","clientes.cliente.sobrenome") as cliente_nome_completo'
        ]);
    ...
    public function get_produtos_mais_vendidos()
    {
        $this->db->select([
            'venda_produtos.*',
            'SUM(venda_produtos.venda_produto_quantidade) as quantidades_vendidas',
            'produtos.produto_id',
        ...
        $this->db->order_by('quantidades_vendidas', 'DESC');
    ...
    public function get_servicos_mais_vendidos()
    {
        $this->db->select([
            'ordem_tem_servicos.*',
            'SUM(ordem_tem_servicos.ordem_ts_quantidade) as quantidade_vendidos',
            'servicos.servico_id ',
