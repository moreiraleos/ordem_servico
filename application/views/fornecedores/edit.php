                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-user" name="fornecedor_razao" id="fornecedor_razao" placeholder="Razão social" value="<?= $fornecedor->fornecedor_razao; ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-user" name="fornecedor_nome_fantasia" id="fornecedor_nome_fantasia" placeholder="Nome fantasia" value="<?= $fornecedor->fornecedor_nome_fantasia; ?>">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user cnpj" name="fornecedor_cnpj" id="fornecedor_cnpj" placeholder="CNPJ" value="<?= $fornecedor->fornecedor_cnpj; ?>">
                                <?= form_error('fornecedor_cnpj', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                <label for="fornecedor_ie">Inscrição Estadual</label>
                                <input type="text" class="form-control form-control-user" name="fornecedor_ie" id="fornecedor_ie" placeholder="Inscrição estadual" value="<?= $fornecedor->fornecedor_ie; ?>">
                                <?= form_error('fornecedor_ie', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                <label for="fornecedor_telefone">Telefone fixo</label>
                                <input type="text" class="form-control form-control-user phone_with_ddd" name="fornecedor_telefone" id="fornecedor_telefone" placeholder="Telefone fixo" value="<?= $fornecedor->fornecedor_telefone; ?>">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user cell_phone_with_ddd" name="fornecedor_celular" id="fornecedor_celular" placeholder="Telefone celular" value="<?= $fornecedor->fornecedor_celular; ?>">
                                <?= form_error('fornecedor_celular', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                <label for="fornecedor_email">E-mail</label>
                                <input type="email" class="form-control form-control-user" name="fornecedor_email" id="fornecedor_email" placeholder="E-mail" value="<?= $fornecedor->fornecedor_email; ?>">
                                <?= form_error('fornecedor_email', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                <label for="fornecedor_contato">Nome do contato</label>
                                <input type="text" class="form-control form-control-user" name="fornecedor_contato" id="fornecedor_contato" placeholder="Nome do atendente" value="<?= $fornecedor->fornecedor_contato; ?>">
                        ...
                        <fieldset class="mt-4 border p-2">
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="fornecedor_endereco" id="fornecedor_endereco" placeholder="Endereço do Fornecedor" value="<?= $fornecedor->fornecedor_endereco; ?>">
                                    <?= form_error('fornecedor_endereco', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-2">
                                    <label for="fornecedor_numero_endereco">Número</label>
                                    <input type="text" class="form-control form-control-user" name="fornecedor_numero_endereco" id="fornecedor_numero_endereco" placeholder="Número endereço" value="<?= $fornecedor->fornecedor_numero_endereco; ?>">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="fornecedor_complemento" id="fornecedor_complemento" placeholder="Complemento" value="<?= $fornecedor->fornecedor_complemento; ?>">
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="fornecedor_bairro" id="fornecedor_bairro" placeholder="Bairro do Fornecedor" value="<?= $fornecedor->fornecedor_bairro; ?>">
                                    <?= form_error('fornecedor_bairro', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-2">
                                    <label for="fornecedor_cep">CEP</label>
                                    <input type="text" class="form-control form-control-user cep" name="fornecedor_cep" id="fornecedor_cep" placeholder="CEP do Fornecedor" value="<?= $fornecedor->fornecedor_cep; ?>">
                                    <?= form_error('fornecedor_cep', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-5">
                                    <label for="fornecedor_cidade">Cidade</label>
                                    <input type="text" class="form-control form-control-user" name="fornecedor_cidade" id="fornecedor_cidade" placeholder="Cidade do Fornecedor" value="<?= $fornecedor->fornecedor_cidade; ?>">
                                    <?= form_error('fornecedor_cidade', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                                <div class="col-md-1">
                                    <label for="fornecedor_estado">UF</label>
                                    <input type="text" class="form-control form-control-user uf" name="fornecedor_estado" id="fornecedor_estado" placeholder="UF" value="<?= $fornecedor->fornecedor_estado; ?>">
                        ...
                        <fieldset class="mt-4 border p-2 mb-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea type="text" class="form-control form-control-user" rows="4" name="fornecedor_obs" id="fornecedor_obs" placeholder="Observações"><?= $fornecedor->fornecedor_obs; ?></textarea>
