        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo usuário" href="<?= base_url('usuarios/add') ?>" class="btn btn-success btn-sm float-right">
                    <i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Novo</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($usuarios as $user) : ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4"><?= ($user->active == 1) ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-pill badge-warning btn-sm">Não</span>' ?></td>
                                    <td class="text-right"><a title="Editar" href="<?= base_url('usuarios/edit/' . $user->id) ?>" class="btn btn-sm btn-primary"> <i class="fas fa-user-edit"></i> Editar</a>
                                        <a title="Excluir" href="javascript(void)" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#user-<?= $user->id ?>"> <i class="fas fa-user-times"></i> Excluir</a>
                                    </td>
                                </tr>
                                <!-- Del Modal-->
