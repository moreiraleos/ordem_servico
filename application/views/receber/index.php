    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo conta" href="<?= base_url('receber/add') ?>" class="btn btn-success btn-sm float-right">
                        ...
                        <tbody>
                            <?php foreach ($contas_receber as $conta) : ?>
                                <tr>
                                    ...
                                    <td><?= $conta->cliente ?></td>
                                    <td><?= 'R$&nbsp;' . $conta->conta_receber_valor ?></td>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td class="" width="150px"><a title="Editar" href="<?= base_url('receber/edit/' . $conta->conta_receber_id) ?>" class="btn btn-sm btn-primary"> <i class="fas fa-edit"></i> Editar</a>
                                        <a title="Excluir" href="javascript(void)" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#conta-<?= $conta->conta_receber_id  ?>"> <i class="fas fa-trash"></i> Excluir</a>
                                    </td>
                                </tr>
                                <!-- Del Modal-->
